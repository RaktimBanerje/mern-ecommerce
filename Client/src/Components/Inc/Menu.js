...

                {
                    ...
                    categories.map((category, idx) => (
                        <li className="nav-item" key={idx}>
                            <a className="nav-link collapsed" href="#" data-toggle="collapse" data-target={`#category-${idx}`}
                                aria-expanded="true" aria-controls="collapseTwo">
                                <span>{category.name}</span>
                            </a>
                            <div id={`category-${idx}`} className="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
